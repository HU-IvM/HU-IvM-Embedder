...
function huivm_embedder_mam( $atts ) {
   ...
   if ($a['type'] == "audio")
   {
	   return '<div class="humamaudio" style="position:relative;overflow:hidden;width:600px;height:40px;margin:20px 0px;"><iframe width="600" height="40" src="https://stream.hu.nl/players/'.$a['id'].'-'.$playerAudio.'.html"></iframe></div>';
   }
   else # Dan zal het wel video zijn, me dunkt
   {
	   return '<div class="humamvideo" style="position:relative;overflow:hidden;width:100%;padding-top: 56.25%;"><iframe style="position:absolute;top:0;left:0;bottom:0;right:0;width:100%;height:100%;" src="https://stream.hu.nl/players/'.$a['id'].'-'.$playerVideo.'.html" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>';
   }
}
...
function huivm_embedder_knightlab( $atts ) {
   ...
   return '<div class="knightlab-embed" style="position:relative;overflow:hidden;width:100%;padding-top: 56.25%;"><iframe style="position:absolute;top:0;left:0;bottom:0;right:0;width:100%;height:100%;" src="https://cdn.knightlab.com/libs/timeline3/latest/embed/index.html?source='.$a['id'].'&font=Default&lang=en&initial_zoom=2&height=100%" width="100%" frameborder="0"></iframe></div>';
}
